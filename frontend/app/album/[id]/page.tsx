...
export default function AlbumDetails() {
  ...
  // Extração baseada na interface tipada
  ...
  const artistaNome = music.artist?.nome || music.artist?.name || "Artista Desconhecido";
  ...
  return (
      <div className="flex flex-col gap-8 pb-24 p-8">
        ...
        <div className="mt-8 flex flex-col max-w-4xl">
          ...
          <div className="grid grid-cols-[30px_1fr_100px] gap-4 px-4 py-3 hover:bg-zinc-800/60 rounded-md text-sm items-center transition-colors cursor-pointer" onClick={togglePlay}>
