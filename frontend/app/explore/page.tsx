...
export default function Explore() {
  ...
  // Lógica de filtro adaptada para o novo modelo de objeto
  const filteredMusics = selectedGenre
      ? musics.filter((music) => {
        const generoNome = music.genre?.nome || music.genero?.nome || music.genre || music.genero;
        return generoNome === selectedGenre;
      })
      : musics;
